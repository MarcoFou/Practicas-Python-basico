...
#tengo que convertit lista en formato soportado por tk
lista_items = StringVar(value=lista_items)
listbox = tkinter.Listbox(windoe, height=100, listvariable=lista_items
